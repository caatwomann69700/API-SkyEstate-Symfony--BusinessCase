 ...
 */
final class Version20250116141227 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP lastname, DROP firstname, DROP birthdate, DROP phone, DROP gender, DROP address, DROP city, DROP country, DROP created_at, DROP updated_at');
    }
}
