 ...
 */
final class Version20250119213913 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD taxes NUMERIC(10, 2) NOT NULL, ADD service_fees NUMERIC(10, 2) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP taxes, DROP service_fees');
